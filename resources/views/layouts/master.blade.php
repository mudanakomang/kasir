            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-footer">
                        <a href="{{ url('password/reset')}}" class="btn btn-default btn-flat">Reset Password</a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                  <a href="#" class="d-block" id="tanggal"><h2></h2></a>
                    <a href="#" class="d-block" id="jam"></a>
                </div>
            </div>
...
<script>
    ...
    function update() {
        moment.locale('id')
        $('#tanggal').html('<h3>'+moment().format('D MMMM YYYY')+'</h3>');
        $('#jam').html('<h3>'+moment().format('H:mm:ss')+'</h3>');
        }
